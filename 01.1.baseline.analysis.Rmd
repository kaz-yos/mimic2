...
--------------------
```{r, w = 10}
ggplot(data = subset(dataIcuStayDetail, HOSPITAL_EXPIRE_FLG %in% c("Y","N")),
       mapping = aes(x = SAPSI_FIRST, fill = HOSPITAL_EXPIRE_FLG)) +
...
--------------------
```{r}
table(dataIcuStayDetail$HOSPITAL_EXPIRE_FLG)
```
